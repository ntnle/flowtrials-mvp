<script>
  ...
  onMount(async () => {
    ...
    if (urlParams.get('participationSuccess') === 'true') {
        ...
        <div class="space-y-4">
          ...
          {:else}
            {#each requests as request}
              <Card class="cursor-pointer hover:shadow-md transition-shadow" on:click={() => push(`/study/${request.study_id}`)}>
                <CardHeader>
      ...
      {#if activeTab === 'info'}
        <div class="space-y-6">
          ...
          <Card>
            ...
            <CardContent class="space-y-4">
              <div class="space-y-2">
                <label class="text-sm font-medium">Select all conditions that apply</label>
          ...
          <Card>
            ...
            <CardContent class="space-y-4">
              ...
              <div class="space-y-2">
                <label class="text-sm font-medium">Trial Format Preferences</label>
